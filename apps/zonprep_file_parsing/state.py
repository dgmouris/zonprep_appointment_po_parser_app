...
STATES = [
    CREATED,
    SENT_TO_FULFILLMENT,
    FULFILLMENT_NOT_REPLIED,
    FULFILLMENT_RAW_ATTACHMENT_DOWNLOADED,
    INCORRECT_FULFILLMENT_ATTACHMENT_RECEIVED,
    SUCCESSFUL_OCR_ATTACHMENT_PARSE,
    ERROR_OCR_ATTACHMENT_PARSE,
    INVALID_ATTACHMENT,
    SUCCESSFUL_APPOINTMENT_INFO_UPDATED,
    SUCCESSFUL_APPOINTMENT_PO_DATA_CREATED,
    SUCCESS_SALESFORCE_APPOINTMENT_DATA_UPLOADED,
    ERROR_SALESFORCE_APPOINTMENT_DATA_UPLOADED,
]

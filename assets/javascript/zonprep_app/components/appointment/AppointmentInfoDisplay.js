  ...
  return (
    <section className="app-card">
      <div className="px-4 sm:px-0">
        ...
        <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-500">Appointment Details
          { data.raw_attachment_download &&
            <>
              <br/>
              <a href={data.raw_attachment_download } target="_blank" className="text-blue-500">View PDF</a>
            </>
          }
        </p>
